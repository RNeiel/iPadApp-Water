...
//        }
        ...
        consumptionChart.rightAxis.enabled = false
        consumptionChart.drawValueAboveBarEnabled = false
        consumptionChart.userInteractionEnabled = false
       // consumptionChart.getBarBounds(<#T##e: BarChartDataEntry##BarChartDataEntry#>)
